...
SCENARIO:
- scenario.title: Weekly planning conflict over release priority
- scenario.type: conflict
- scenario.trigger_event: Two managers disagree on sprint allocation during a weekly planning meeting with moderate stakes and low external visibility.
